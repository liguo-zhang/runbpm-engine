...
public class ParallelGateway {
	...
	public static void test() throws Exception{
		...
		String fileName = "ParallelGateway.xml";
		ClassPathResource classPathResource = new ClassPathResource(fileName,ParallelGateway.class);
		runtimeService.initProcessDefinitionFromFile(classPathResource.getFile());
		
		ProcessInstance processInstance = runtimeService.createProcessInstance("Payment",null);
