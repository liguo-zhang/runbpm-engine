package org.runbpm.spring.persistence.redis_hibernate;
...
public class ParallelGateway_RedisHibernate extends RunBPMTestCase{
	
	@Before
	public void before(){
		ClassPathXmlApplicationContext appContext = new ClassPathXmlApplicationContext(
				"RunBPM.redis_hibernate_spring_context.xml",this.getClass());
