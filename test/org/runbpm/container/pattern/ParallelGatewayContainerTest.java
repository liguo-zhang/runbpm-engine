...
public class ParallelGatewayContainerTest extends RunBPMTestCase{
	...
	public void test() throws Exception{
		...
		Assert.assertEquals("" , entityManager.listActivityInstanceByProcessInstId(processInstance.getId()).size(),6);
		...
		ActivityInstance activityInstance_Instance_1_3 = entityManager.listActivityInstanceByActivityDefId(processInstanceId, "theStart").iterator().next();
		ActivityInstance activityInstance_Instance_2_3 = entityManager.listActivityInstanceByActivityDefId(processInstanceId, "fork").iterator().next();
		ActivityInstance activityInstance_Instance_3_3 = entityManager.listActivityInstanceByActivityDefId(processInstanceId, "receivePayment").iterator().next();
		ActivityInstance activityInstance_Instance_4_3 = entityManager.listActivityInstanceByActivityDefId(processInstanceId, "shipOrder").iterator().next();
		ActivityInstance activityInstance_Instance_5_3 = entityManager.listActivityInstanceByActivityDefId(processInstanceId, "join").iterator().next();
		ActivityInstance activityInstance_Instance_6_3 = entityManager.listActivityInstanceByActivityDefId(processInstanceId, "archiveOrder").iterator().next();
		ActivityInstance activityInstance_Instance_7_3 = entityManager.listActivityInstanceByActivityDefId(processInstanceId, "theEnd").iterator().next();
		  
		Assert.assertEquals("" , entityManager.listActivityInstanceByProcessInstId(processInstance.getId()).size(),7);
	...
	public void testBack() throws IOException{
		...
		Assert.assertEquals("",entityManager.listActivityInstanceByActivityDefId(processInstanceId, "shipOrder").size(),2);
		Assert.assertEquals("" , activityInstance_Instance_5_3.getState(),ACTIVITY_STATE.COMPLETED);
